...
// Insert
  Future<void> _addField() async {
    await FieldTBL.createField(
        _fieldNameController.text, _addressController.text,  _descriptionController.text);
    _refreshFieldList();
  }

  // Update
  Future<void> _updateField(int id) async {
    await FieldTBL.updateField(
        id, _fieldNameController.text, _addressController.text,  _descriptionController.text);
    _refreshFieldList();
  }
